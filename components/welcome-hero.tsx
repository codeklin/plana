...
export default function WelcomeHero({ userName = 'User', totalBalance, monthlyGoal }: WelcomeHeroProps) {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 mb-6 animate-in fade-in slide-in-from-top-4 duration-500">
      {/* Welcome Message */}
      <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-500 dark:via-purple-500 dark:to-pink-500 rounded-2xl p-4 sm:p-6 text-white shadow-lg">
        ...
        <p className="text-white/90 mt-3 sm:mt-4 text-sm sm:text-base leading-relaxed">
